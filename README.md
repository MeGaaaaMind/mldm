...
- `code/cnn_code.ipynb` — TensorFlow CNN pipeline for 3-class image classification with augmentation, checkpoints, and evaluation utilities.
- `code/mlp.py` — lightweight script to train a Multi-Layer Perceptron (MLP)
...
### Image Classification (`code/cnn_code.ipynb`)
...
- **MLP:** The result of test accuracy of around 84%.
